...
real neighboring audio, and the file's own edges take none: the first chunk's
window begins at the file start and the last chunk's ends at the file end,
extending further left instead, so both file edges come out as an unchunked
